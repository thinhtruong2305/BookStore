    ...
    public class BookMappingProfile : Profile
    {
        public BookMappingProfile()
        {
            ...
            CreateMap<Book, BookDetailClientModel>()
                ...
                .ForMember(dest => dest.Price, opt => opt.MapFrom(src => src.Edition.Price))
                .ForMember(dest => dest.DiscountPrice, opt => opt.MapFrom(src => src.Edition.Price - ((src.Edition.Price * src.Info.DiscountPercent) / 100))).ForMember(dest => dest.Format, opt => opt.MapFrom(src => src.Edition.Format))
